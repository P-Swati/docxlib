...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SliceDocLibraryT3.InlineObject3();
  });
  ...
  describe('InlineObject3', function() {
    it('should create an instance of InlineObject3', function() {
      ...
      //var instane = new SliceDocLibraryT3.InlineObject3();
      //expect(instance).to.be.a(SliceDocLibraryT3.InlineObject3);
    });
    ...
    it('should have the property gdriveClientCredentials (base name: "gdriveClientCredentials")', function() {
      ...
      //var instance = new SliceDocLibraryT3.InlineObject3();
