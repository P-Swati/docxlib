...
var _GdriveClientCredentials = _interopRequireDefault(require("./GdriveClientCredentials"));

var _GdriveToken = _interopRequireDefault(require("./GdriveToken"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('token')) {
          obj['token'] = _GdriveToken["default"].constructFromObject(data['token']);
        }

        if (data.hasOwnProperty('gdriveClientCredentials')) {
          obj['gdriveClientCredentials'] = _GdriveClientCredentials["default"].constructFromObject(data['gdriveClientCredentials']);
        }
      }
