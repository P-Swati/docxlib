...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocxlibJs.InlineObject3();
  });
  ...
  describe('InlineObject3', function() {
    it('should create an instance of InlineObject3', function() {
      ...
      //var instane = new DocxlibJs.InlineObject3();
      //expect(instance).to.be.a(DocxlibJs.InlineObject3);
    });
    ...
    it('should have the property gdriveClientCredentials (base name: "gdriveClientCredentials")', function() {
      ...
      //var instance = new DocxlibJs.InlineObject3();
