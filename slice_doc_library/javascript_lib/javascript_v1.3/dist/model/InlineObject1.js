...
var _DigiMockerToken = _interopRequireDefault(require("./DigiMockerToken"));
...
var InlineObject1 = /*#__PURE__*/function () {
   ...
   * @param token {module:model/DigiMockerToken} 
   */
  function InlineObject1(email, password, token) {
    _classCallCheck(this, InlineObject1);

    InlineObject1.initialize(this, email, password, token);
  }
  /**
  ...
  _createClass(InlineObject1, null, [{
    key: "initialize",
    value: function initialize(obj, email, password, token) {
      obj['email'] = email;
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('token')) {
          obj['token'] = _DigiMockerToken["default"].constructFromObject(data['token']);
        }
      }
