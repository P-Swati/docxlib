...
export default class SourcesApi {
    ...
    */
     ...
     */
    digiMockerSourceAuthCallback(opts, callback) {
      opts = opts || {};
      ...
      let returnType = DigiMockerToken;
      return this.apiClient.callApi(
        '/source/digimocker/oauth2callback', 'POST',
     ...
     */
    digimockerSourceListFiles(opts, callback) {
      opts = opts || {};
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = DigiMockerFileList;
      return this.apiClient.callApi(
        '/source/digimocker/listFiles', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
