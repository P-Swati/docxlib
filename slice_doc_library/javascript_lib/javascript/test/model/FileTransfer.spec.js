...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SliceDocLibraryT3.FileTransfer();
  });
  ...
  describe('FileTransfer', function() {
    it('should create an instance of FileTransfer', function() {
      ...
      //var instane = new SliceDocLibraryT3.FileTransfer();
      //expect(instance).to.be.a(SliceDocLibraryT3.FileTransfer);
    });
    ...
    it('should have the property sourceConfig (base name: "sourceConfig")', function() {
      ...
      //var instance = new SliceDocLibraryT3.FileTransfer();
