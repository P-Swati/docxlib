...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocxlibJs.InlineObject4();
  });
  ...
  describe('InlineObject4', function() {
    it('should create an instance of InlineObject4', function() {
      ...
      //var instane = new DocxlibJs.InlineObject4();
      //expect(instance).to.be.a(DocxlibJs.InlineObject4);
    });

    it('should have the property token (base name: "token")', function() {
      // uncomment below and update the code to test the property token
      //var instance = new DocxlibJs.InlineObject4();
