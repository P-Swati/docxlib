...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SliceDocLibraryT3.InlineObject1();
  });
  ...
  describe('InlineObject1', function() {
    it('should create an instance of InlineObject1', function() {
      ...
      //var instane = new SliceDocLibraryT3.InlineObject1();
      //expect(instance).to.be.a(SliceDocLibraryT3.InlineObject1);
    });
    ...
    it('should have the property gdriveClientCredentials (base name: "gdriveClientCredentials")', function() {
      ...
      //var instance = new SliceDocLibraryT3.InlineObject1();
