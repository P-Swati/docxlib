...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SliceDocLibraryT3.InlineObject();
  });
  ...
  describe('InlineObject', function() {
    it('should create an instance of InlineObject', function() {
      ...
      //var instane = new SliceDocLibraryT3.InlineObject();
      //expect(instance).to.be.a(SliceDocLibraryT3.InlineObject);
    });
    ...
    it('should have the property gdriveClientCredentials (base name: "gdriveClientCredentials")', function() {
      ...
      //var instance = new SliceDocLibraryT3.InlineObject();
