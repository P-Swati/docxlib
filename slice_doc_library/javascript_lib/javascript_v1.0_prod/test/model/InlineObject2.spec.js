...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocxlibJs.InlineObject2();
  });
  ...
  describe('InlineObject2', function() {
    it('should create an instance of InlineObject2', function() {
      ...
      //var instane = new DocxlibJs.InlineObject2();
      //expect(instance).to.be.a(DocxlibJs.InlineObject2);
    });
    ...
    it('should have the property gdriveClientCredentials (base name: "gdriveClientCredentials")', function() {
      ...
      //var instance = new DocxlibJs.InlineObject2();
