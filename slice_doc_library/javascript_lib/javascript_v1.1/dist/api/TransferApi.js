...
var TransferApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(TransferApi, [{
    key: "fileTransfer",
    value: function fileTransfer(_fileTransfer, callback) {
      var postBody = _fileTransfer; // verify the required parameter 'fileTransfer' is set

      if (_fileTransfer === undefined || _fileTransfer === null) {
