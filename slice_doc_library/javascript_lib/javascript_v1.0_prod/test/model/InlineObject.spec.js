...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocxlibJs.InlineObject();
  });
  ...
  describe('InlineObject', function() {
    it('should create an instance of InlineObject', function() {
      ...
      //var instane = new DocxlibJs.InlineObject();
      //expect(instance).to.be.a(DocxlibJs.InlineObject);
    });

    it('should have the property email (base name: "email")', function() {
      // uncomment below and update the code to test the property email
      //var instance = new DocxlibJs.InlineObject();
