...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SliceDocLibraryT3.DigimockerFile();
  });
  ...
  describe('DigimockerFile', function() {
    it('should create an instance of DigimockerFile', function() {
      ...
      //var instane = new SliceDocLibraryT3.DigimockerFile();
      //expect(instance).to.be.a(SliceDocLibraryT3.DigimockerFile);
    });
    ...
    it('should have the property exported (base name: "exported")', function() {
      ...
      //var instance = new SliceDocLibraryT3.DigimockerFile();
