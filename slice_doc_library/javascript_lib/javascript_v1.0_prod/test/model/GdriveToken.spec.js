...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocxlibJs.GdriveToken();
  });
  ...
  describe('GdriveToken', function() {
    it('should create an instance of GdriveToken', function() {
      ...
      //var instane = new DocxlibJs.GdriveToken();
      //expect(instance).to.be.a(DocxlibJs.GdriveToken);
    });
    ...
    it('should have the property accessToken (base name: "access_token")', function() {
      ...
      //var instance = new DocxlibJs.GdriveToken();
